...
WATERMARK_LOGO = "DBM-logo.png"

# Footer Configuration
FOOTER_TEXT_CENTER = "Divya Bihar Mission"
FOOTER_URL = "https://divyabiharmission.com"
...
if __name__ == "__main__":
    print("Starting PDF Branding for Divya Bihar Mission...")
    input_path = None
    if filedialog:
    ...
    if not input_path:
        ...
        default_output = f"DBM_{base_name}" if base_name else "DBM_BRANDED_output.pdf"
